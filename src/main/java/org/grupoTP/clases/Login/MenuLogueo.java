...
public class MenuLogueo {
        ...
        do {
            ...
            if(compruebaSalida(mail)) {
                ...
                if (empleadoEncontrado != null) {
                    usuarioValido = true;
                    do {
                        System.out.print("\nIngrese su contraseña de 4 caracteres o '0' para salir: ");
                        contrasena = scan.nextLine();
                        if (compruebaSalida(contrasena)) {
    ...
    public static boolean compruebaSalida(String mail){

        if(mail.length() == 1) {
            int out = Integer.parseInt(mail);
            if (out == 0) {
